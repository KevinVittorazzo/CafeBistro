  ...
  <main>
    ...
    <section class="container-form">
      <form method="POST" action="processar-cadastro.php">
        ...
        <input type="password" id="confirmarsenha" name="confirmarsenha" placeholder="Confirmar sua senha" required>
...
<?php
  ...
  if(isset($_GET["erro"])){
    // echo " Erro! Senhas não são iguais.
    ?>
    <label for="erro">Senhas não são iguais</label>
    <?php } 
    ?>
